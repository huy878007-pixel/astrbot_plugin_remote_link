...
[![下载本地端](https://img.shields.io/badge/⬇%20下载本地代理-Windows%20x64%20·%20免装%20Python-2f6da0?style=for-the-badge)](https://github.com/huy878007-pixel/astrbot_plugin_remote_link/releases/latest/download/YunxinAgent-v0.1.1-win64.zip)
[![下载插件](https://img.shields.io/badge/⬇%20下载云端插件-AstrBot%20zip-3a6a4a?style=for-the-badge)](https://github.com/huy878007-pixel/astrbot_plugin_remote_link/releases/latest/download/yunxin-plugin-v0.1.1.zip)
...
| 文件 | 内容 | 给谁 |
| --- | --- | --- |
| `YunxinAgent-v0.1.1-win64.zip` | exe + 配置模板 + 启动脚本 + 说明 | 本地电脑，解压双击 |
| `yunxin-plugin-v0.1.1.zip` | 插件本体（`main.py` / `tools/` / `pages/` / Schema） | 云端 AstrBot |
| `yunxin-src-v0.1.1.zip` | 完整源码（含测试、预览服务器、文档、截图） | 二次开发 |
